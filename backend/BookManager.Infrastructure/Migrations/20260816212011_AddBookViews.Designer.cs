...
namespace BookManager.Infrastructure.Migrations
{
    ...
    [Migration("20260816212011_AddBookViews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.BookView", b =>
                {
                    b.Property<Guid>("BookId")
                        .HasColumnType("uuid");

                    b.Property<long>("LastSeenEventId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BookManager.Domain.Entities.BookView", b =>
                {
                    b.HasOne("BookManager.Domain.Entities.Book", null)
                        .WithOne()
                        .HasForeignKey("BookManager.Domain.Entities.BookView", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
